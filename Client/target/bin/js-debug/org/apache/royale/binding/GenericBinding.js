  ...
  if (this.destinationFunction != null) {
    ...
    if (obj == null) {
      if (!this.org_apache_royale_binding_GenericBinding__listening) {
        this.document.addEventListener(org.apache.royale.events.ValueChangeEvent.VALUE_CHANGE, org.apache.royale.utils.Language.closure(this.org_apache_royale_binding_GenericBinding_destinationChangeHandler, this, 'destinationChangeHandler'));
