...
org.apache.royale.binding.ChainBinding.prototype.org_apache_royale_binding_ChainBinding_evaluateSourceChain = function() {
  ...
  for (var /** @type {number} */ i = 0; i < n - 1; i++) {
    ...
    var /** @type {org.apache.royale.binding.ChainBinding.ChainWatcher} */ watcher = new org.apache.royale.binding.ChainBinding.ChainWatcher(propName, org.apache.royale.utils.Language.closure(this.org_apache_royale_binding_ChainBinding_applyBinding, this, 'applyBinding'));
