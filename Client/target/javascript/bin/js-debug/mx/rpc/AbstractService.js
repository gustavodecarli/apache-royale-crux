...
mx.rpc.AbstractService.prototype.bindable__set__channelSet_mx_rpc_AbstractService = function(value) {
...
var oldValue = this.get__channelSet();
if (oldValue != value) {
this.bindable__set__channelSet_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "channelSet", oldValue, value));
}
};
...
mx.rpc.AbstractService.prototype.bindable__set__destination_mx_rpc_AbstractService = function(name) {
  this.http_$$www_adobe_com$2006$flex$mx$internal__asyncRequest.destination = name;
};


mx.rpc.AbstractService.prototype.set__destination = function(value) {
var oldValue = this.get__destination();
if (oldValue != value) {
this.bindable__set__destination_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "destination", oldValue, value));
}
};
...
mx.rpc.AbstractService.prototype.bindable__set__managers_mx_rpc_AbstractService = function(mgrs) {
...
mx.rpc.AbstractService.prototype.set__managers = function(value) {
var oldValue = this.get__managers();
if (oldValue != value) {
this.bindable__set__managers_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "managers", oldValue, value));
}
};
...
mx.rpc.AbstractService.prototype.bindable__set__operations_mx_rpc_AbstractService = function(ops) {
...
mx.rpc.AbstractService.prototype.set__operations = function(value) {
var oldValue = this.get__operations();
if (oldValue != value) {
this.bindable__set__operations_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "operations", oldValue, value));
}
};
...
mx.rpc.AbstractService.prototype.bindable__set__requestTimeout_mx_rpc_AbstractService = function(value) {
...
var oldValue = this.get__requestTimeout();
if (oldValue != value) {
this.bindable__set__requestTimeout_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "requestTimeout", oldValue, value));
}
};
...
mx.rpc.AbstractService.prototype.bindable__set__keepLastResult_mx_rpc_AbstractService = function(value) {
  this._keepLastResult = value;
};


mx.rpc.AbstractService.prototype.set__keepLastResult = function(value) {
var oldValue = this.get__keepLastResult();
if (oldValue != value) {
this.bindable__set__keepLastResult_mx_rpc_AbstractService(value);
    this.dispatchEvent(org.apache.royale.events.ValueChangeEvent.createUpdateEvent(
         this, "keepLastResult", oldValue, value));
}
};
 ...
 * @type {number}
 */
mx.rpc.AbstractService.prototype.ROYALE_COMPILE_FLAGS = 10;
