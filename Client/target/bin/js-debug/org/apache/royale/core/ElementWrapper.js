...
org.apache.royale.core.ElementWrapper.fireListenerOverride = function(listener, eventObject) {
  ...
  var /** @type {Object} */ converter = org.apache.royale.core.ElementWrapper.converterMap[nativeEvent.constructor.name];
  if (converter)
    e = converter["convert"](nativeEvent, eventObject); else {
