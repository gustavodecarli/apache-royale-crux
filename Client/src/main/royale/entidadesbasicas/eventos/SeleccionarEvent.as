...
package entidadesbasicas.eventos
{
	 ...
	 */
	public class SeleccionarEvent extends Event
	{
		public static const SELECCIONAR : String = "seleccionar";
		
		public var modelo : ModeloBase;
		 ...
		 */ 
		public function SeleccionarEvent( type:String )
		{
			super( type, true );
		}
	}
